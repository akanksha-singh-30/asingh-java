...
insert into ticket  (ticket_type, id, title, description, status, application_id) values ('T', 1, 'Ticket 1', 'Description 1', 'DRAFT', null);
insert into ticket  (ticket_type, id, title, description, status, application_id) values ('T', 2, 'Ticket 2', 'Description 2', 'DRAFT', null);
insert into ticket  (ticket_type, id, title, description, status, application_id) values ('T', 3, 'Ticket 3', 'Description 3', 'DRAFT', 3);
insert into ticket  (ticket_type, id, title, description, status, application_id) values ('T', 4, 'Ticket 4', 'Description 4', 'DRAFT', null);
insert into ticket  (ticket_type, id, title, description, status, application_id) values ('T', 5, 'Ticket 5', 'Description 5', 'DRAFT', null);
